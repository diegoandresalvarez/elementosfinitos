...
elemento         = 'L9';  % S8 L9
elementos_planos = true;  % true false

%% Se define el nombre del archivo y se verifica si elemento está OK
if strcmp(elemento,'S8')
   if elementos_planos   
      filename = 'malla_scordelli_lo_plano_S8';
   else
      filename = 'malla_scordelli_lo_curvo_S8';
   end
elseif strcmp(elemento,'L9')
   if elementos_planos   
      filename = 'malla_scordelli_lo_plano_L9';
   else
      filename = 'malla_scordelli_lo_curvo_L9';
   end
else 
