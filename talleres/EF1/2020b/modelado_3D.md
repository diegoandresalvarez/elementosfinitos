...
Por favor reportar los grupos de trabajo en GOOGLE CALENDAR.

Fecha y hora de entrega: se especificará en GOOGLE CLASSROOM. Por cada día dos horas de retrazo se descontarán 2 décimas de la nota final.
...
* Calcular las reacciones en los apoyos. Calcular las tracciones asociadas al tornillo del apoyo.
...
* NOTA MAXIMA 7.0. Tenga en cuenta que la nota tiene un componente individual (los videos) y otro grupal (el informe escrito).

* VIDEO 1: Modelado de la estructura (2.6)
  * 0.1 Modeló adecuadamente las condiciones de frontera (modelado de apoyos y cargas)
  * 0.4 Calculó las reacciones en los apoyos (y *fuerzas* asociadas al tornillo).
...
* Por cada día dos horas de retrazo se descontarán 2 décimas de la nota final.
