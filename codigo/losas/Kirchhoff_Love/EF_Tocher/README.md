# Cálculo de una losa simplemente apoyada en sus cuatro bordes utilizando el EF de losa de Tocher
...
La losa se calculó con elementos finitos de Tocher en el archivo [EF_Tocher.m](EF_Tocher.m) obteniendo los siguientes diagramas:
