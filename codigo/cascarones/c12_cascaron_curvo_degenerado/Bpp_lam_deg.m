function [Bpp, det_J] = Bpp_lam_deg(e, xi, eta, zeta)
%% Calcula la matriz Bpp para el elemento de lamina degenerada en el punto 
%% de coordenadas (xi,eta,zeta)
%
% [Bpp, det_J] = Bpp_lam_deg(e, xi, eta, zeta)
% 
% e                      numero del EF
