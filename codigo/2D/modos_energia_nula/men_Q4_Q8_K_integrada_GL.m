...
%% Programa para calcular los modos de energia nula de los EFs rectagulares
...
nno = 8; % 4 u 8     % numeros de nodos del EF
...
%% Se calculan y normalizan los modos de desplazamiento y rotacion rigida
RmatT = [ cosd(45) -sind(45)
          sind(45)  cosd(45)]'; % matriz de rotacion xr = Rmat*x
a1 = a1/norm(a1);
a2 = a2/norm(a2);
a3 = (xnod*RmatT)';   a3 = a3(:)/norm(a3);
mdrrr = [a1 a2 a3];
...
%% garantizar que K es simetrica, para evitar vectores propios complejos en
%% eig
K = (K+K')/2; 
...
sgtitle(sprintf('Puntos de integracion = %dx%d, MEN = %d', n_gl, n_gl, num_MEN));
